...
function init() {
    ...
    const addLight = ( hexColor, power = 10, distance = 3 ) => {
        ...
        // const light = new THREE.SpotLight( hexColor, 1000, distance, Math.PI / 8, 0, 1 );
    ...
    const floorColor = textureLoader.load( 'Assets/FloorsCheckerboard_S_Diffuse.jpg' );
    floorColor.wrapS = THREE.RepeatWrapping;
    floorColor.wrapT = THREE.RepeatWrapping;
    floorColor.colorSpace = THREE.SRGBColorSpace;

    const floorNormal = textureLoader.load( 'Assets/FloorsCheckerboard_S_Normal.jpg' );
